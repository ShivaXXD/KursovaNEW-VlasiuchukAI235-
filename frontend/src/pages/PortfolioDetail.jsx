...
export default function PortfolioDetail() {
    ...
    const projectsDB = {
        ...
        // ... (інші проекти можна розширити так само)
        3: {
             ...
             industry: 'Логістика',
             duration: '4 місяці',
             about: 'Компанія швидко росла, але старі процеси гальмували розвиток. Документи губилися, вантажі затримувалися.',
             challenge: 'Хаос в управлінні та відсутність єдиної системи обліку.',
             solution: 'Впровадження CRM-системи, автоматизація документообігу, навчання персоналу.',
             technologies: ['BPMN 2.0', 'Salesforce CRM', 'Slack Integration', 'Jira'],
             team: ['Анна К. (Business Analyst)', 'Сергій В. (Integration Specialist)'],
             stats: [{ label: 'Ефективність', value: '+90%', desc: 'Швидкість обробки заявок', color: 'bg-blue-600' }],
             timeline: [{ date: '2024', event: 'Впровадження' }],
        ...
        4: {
             ...
             category: 'Брендинг',
             client: 'EcoLife',
             industry: 'FMCG / Еко-товари',
             duration: '2 місяці',
             about: 'Новий бренд екологічної побутової хімії виходив на ринок ЄС.',
             challenge: 'Створити впізнаваний візуальний стиль та tone-of-voice, що резонує з європейцями.',
             solution: 'Розробка бренд-буку, дизайну упаковки та комунікаційної стратегії.',
             technologies: ['Adobe Illustrator', 'Cinema 4D', 'Figma', 'Brand Archetypes'],
             team: ['Катерина Л. (Art Director)', 'Павло О. (Brand Manager)'],
             stats: [{ label: 'Впізнаваність', value: 'Top-10', desc: 'У ніші еко-товарів за рік', color: 'bg-green-600' }],
             timeline: [{ date: '2024', event: 'Реліз бренду' }],
